...
# write to csv 
cabi_gbif_match.to_csv(data_dir + "\species lists\gbif_matched\cabi_gbif.csv")
eppo_gbif_match.to_csv(data_dir + "\species lists\gbif_matched\eppo_gbif.csv")
daisie_gbif_match.to_csv(data_dir + "\species lists\gbif_matched\daisie_gbif.csv")
sinas_gbif_match.to_csv(data_dir + "\species lists\gbif_matched\sinas_gbif.csv")
